...
First we create a class called `LongitudinalData` to represent the Longitudinal Data type, 
and aux class `ld_project` to represent concepts of "subject", "visit" or "room". 
`ld_summary` to represent the summary of Longitudinal data.
